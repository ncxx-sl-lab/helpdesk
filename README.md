...
なお、issue への登録は下記の**[質問の登録](https://github.com/ncxx-sl-lab/helpdesk/issues/new?title=質問のタイトル&body=%23%20%20質問の内容%0A%0A%23%20%20何が問題なのか%0A%0A%23%20%20解決方法（質問者への対応が完了した時に記載）)**のボタンをクリックしてから行ってください。
ボタンをクリックすると、質問のひな形作成された状態で issue の登録ページへ画面遷移します。

- **[質問の登録](https://github.com/ncxx-sl-lab/helpdesk/issues/new?title=質問のタイトル&body=%23%20%20質問の内容%0A%0A%23%20%20何が問題なのか%0A%0A%23%20%20解決方法（質問者への対応が完了した時に記載）)**
